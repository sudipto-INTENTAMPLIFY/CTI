...
for(const required of ['dist/pricing.html','dist/CONVERSION_LAYER_CONFIG.js','dist/admin.html','dist/CTI_ADMIN.js','dist/api/content.php','dist/api/vendors.php','dist/api/website-leads.php','dist/.htaccess','dist/api/.htaccess'])await access(required);
